...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <style type="text/css">.wrapper{ text-transform:uppercase; }</style>
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="{{url('salir')}}" class="btn btn-danger btn-flat"><span style="color: black;">Salir</span></a>
                </div>
              </li>
            </ul>
          </li>
