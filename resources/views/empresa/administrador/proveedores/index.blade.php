 		...
 		<template>
    		<div id="home" class="tab-pane fade in active">
        		 <h3>proveedores activos</h3>
      	    		<div class="form-row">
          			@include('empresa.administrador.proveedores.tabs.tab1');
        		</div>
    		</div>
    	</template>
    	...
    	<template>
    		<div id="menu2" class="tab-pane fade">
         		<h3>proveedores desactivados</h3>
      	    		<div class="form-row">
          			@include('empresa.administrador.proveedores.tabs.tab2');
...
<script src="{{asset('js/Vue/adminitrador/proveedor.js')}}"></script>
