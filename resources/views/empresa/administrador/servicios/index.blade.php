 	...
 	<div class="tab-content">
 		<template>
    		<div id="home" class="tab-pane fade in active">
        		 <h3>servicios activos</h3>
      	    		<div class="form-row">
          			@include('empresa.administrador.servicios.tabs.tab1');
        		</div>
    		</div>
    	</template>
    	...
    	<template>
    		<div id="menu2" class="tab-pane fade">
         		<h3>servicios desactivados</h3>
      	    		<div class="form-row">
          			@include('empresa.administrador.servicios.tabs.tab2');
...
<script src="{{asset('js/Vue/adminitrador/servicios.js')}}"></script>
