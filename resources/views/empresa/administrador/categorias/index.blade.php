 	...
 	<div class="tab-content">
 		<template>
    		<div id="home" class="tab-pane fade in active">
        		 <h3>categorias activos</h3>
      	    		<div class="form-row">
          			@include('empresa.administrador.categorias.tabs.tab1');
        		</div>
    		</div>
    	</template>
    	...
    	<template>
    		<div id="menu2" class="tab-pane fade">
         		<h3>categorias inactivos</h3>
      	    		<div class="form-row">
          			@include('empresa.administrador.categorias.tabs.tab2');
...
<script src="{{asset('js/Vue/adminitrador/categorias.js')}}"></script>
